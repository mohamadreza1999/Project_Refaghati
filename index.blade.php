...
<head>
  ...
  <link rel="stylesheet" href="back/assets/vendors/iconfonts/ionicons/css/ionicons.css">
  <link rel="stylesheet" href="back/assets/vendors/iconfonts/typicons/src/font/typicons.css">
                      ...
                      <div class="d-flex align-items-center justify-content-between w-100">
                        ...
                        <div class="dropdown">
                          <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="dateSorter"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">This Month</button>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="d-flex mt-3 py-2 border-bottom">
                        <img class="img-sm rounded-circle" src="back/assets/images/faces/face3.jpg" alt="profile image">
                      ...
                      <div class="d-flex py-2 border-bottom">
                        <img class="img-sm rounded-circle" src="back/assets/images/faces/face4.jpg" alt="profile image">
                        <div class="wrapper ml-2">
                  ...
                  <div class="table-responsive">
                    <table class="table table-stretched">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <p class="mb-1 text-dark font-weight-medium">NFLX</p><small
                              class="font-weight-medium">Netflix, Inc.</small>
                          </td>
                        ...
                        <tr>
                          <td>
                            <p class="mb-1 text-dark font-weight-medium">TSLA</p><small
                              class="font-weight-medium">Tesla, Inc.</small>
                          </td>
                        ...
                        <tr>
                          <td>
                            <p class="mb-1 text-dark font-weight-medium">GOOG</p><small
                              class="font-weight-medium">Alphabet, Inc.</small>
                          </td>
                          <td class="font-weight-medium">$250.00</td>
                        ...
                        <tr>
                          <td>
                            <p class="mb-1 text-dark font-weight-medium">AMZN</p><small
                              class="font-weight-medium">Amazon.com, Inc.</small>
                          </td>
